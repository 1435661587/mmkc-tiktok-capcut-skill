---
name: mmkc-tiktok-capcut-skill
description: >
  基于现有 CapCut 草稿模板生成新草稿，提取模板样式、验证草稿结构，并检查或修复 AI 视频痕迹。
  English: Create new CapCut drafts from existing templates, extract template styles, validate draft structure, and inspect or repair AI-video artifacts.
---
